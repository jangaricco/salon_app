                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('tel') is-invalid @enderror" name="tel" value="{{ old('tel') }}" required>
                    ...
                    <p class="mt-4 text-center">※次回以降、ログインの際にはメールアドレスとパスワードが必要になります。</p>
                </div>
            </div>
        </div>
    </div>
